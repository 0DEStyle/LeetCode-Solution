/*Challenge link:https://leetcode.com/problems/maximum-earnings-from-taxi/description/
Question:
...
public class Solution {
    ...
    //end - start + tip
    int Profit(int[] ride) => ride[1] - ride[0] + ride[2];
    int ByEndTime(int[] x, int[] y) =>  x[1] - y[1];
