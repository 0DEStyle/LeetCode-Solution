/*Challenge link:https://leetcode.com/problems/relative-ranks/description/
Question:
...
public class Solution {
    public string[] FindRelativeRanks(int[] score) {
        //dictionary to store current score and rank
        var scoreDict = new Dictionary<int,int>();

        //assign rank into dictionary
        for(int i = 0; i<score.Length;i++)
            scoreDict[score[i]] = i;
        //sort score array in ascending order
